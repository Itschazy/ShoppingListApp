...
import com.chxzyfps.shoppinglist.databinding.ShopLibraryListItemBinding
import com.chxzyfps.shoppinglist.databinding.ShopListItemBinding
    ...
    class ItemHolder(val view: View) : RecyclerView.ViewHolder(view) {
        fun setItemData(shopListItem: ShopListItem, listener: Listener){
            ...
            binding.apply {
                ...
                chBox.setOnClickListener{
                    listener.onClickItem(shopListItem.copy(itemChecked = chBox.isChecked), state = CHECK_BOX)
                }
                imEdit.setOnClickListener{
                    listener.onClickItem(shopListItem, state = EDIT)
                }
            }
        ...
        fun setLibraryData(shopListItem: ShopListItem, listener: Listener){
            ...
            binding.apply {
                tvName.text = shopListItem.name
                imEdit.setOnClickListener{
                    listener.onClickItem(shopListItem, state = EDIT_LIBRARY_ITEM)
                }
                imDelete.setOnClickListener{
                    listener.onClickItem(shopListItem, state = DELETE_LIBRARY_ITEM)
                }
                itemView.setOnClickListener {
                    listener.onClickItem(shopListItem, state = ADD)
                }
            }
